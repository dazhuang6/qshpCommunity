...
public class LoginController implements CommunityConstant {
     ...
     *
     * @param model
     * @param user 这里的user是在前端注入的user.username等
     * @param password2 这里的密码是通过param.password2注入的
     * @return
     */
    ...
    public String login(String username, String password, String code, boolean remember_me,
